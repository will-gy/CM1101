...
def list_of_items(items):
    ...
    for item in items:
        if item_string == "":
            item_string = str(item["name"])
        else:
            item_string = item_string + ", " + str(item["name"])
    return str(item_string)
...
def execute_take(item_id):
    ...
    #for item in current_room["items"]:
     ...
     #      current_room["items"].remove(item_id)
      #     inventory.append(item_id)
       #    print(item_id["name"] + " has been added to your inventory.")
        #else:
    ...
    for item in current_room["items"]:
        if item_id == item["id"]:
            ...
            print(item["id"] + " has been added to inventory.")
    if in_room == False:
        print("You cannot take that.")
...
def execute_drop(item_id):
    ...
    for item in inventory:
        if item_id == item["id"]:
            ...
            print(item["id"] + " has been removed from inventory.")
    if in_inv == False:
